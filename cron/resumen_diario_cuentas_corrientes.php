...
try {
    ...
    // Validar si el despacho automático está activo
    if (defined('AUTO_DISPATCH_ENABLED') && !AUTO_DISPATCH_ENABLED) {
        echo "[" . date('Y-m-d H:i:s') . "] El despacho automático por hora está desactivado (AUTO_DISPATCH_ENABLED = false).\n";
        exit;
    }
    ...
    foreach ($empresas as $empresa) {
        ...
        $enviado = MailService::enviarResumenDiarioDigitadora($empresa['nombre'], $cobranzas, $destinatario, $ccEmail, $pdo);
