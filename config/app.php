...
define('UPLOADS_BASE_URL', getenv('UPLOADS_BASE_URL') ?: 'http://localhost/form/uploads');
define('PORTAL_BASE_URL', getenv('PORTAL_BASE_URL') ?: 'http://localhost/form/admin/detalle.php');
...
define('MAIL_FROM', getenv('MAIL_FROM') ?: 'cheques@holdingautomarco.com');
