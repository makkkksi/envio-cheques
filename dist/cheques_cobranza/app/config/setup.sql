...
-- 11. Cabeceras de Rendiciones de Gastos y Viaticos
CREATE TABLE IF NOT EXISTS rendiciones_gastos (
  ...
  estado ENUM('BORRADOR', 'ENVIADA', 'PENDIENTE_APROBACION_EXCESO', 'EN_REVISION_TESORERIA', 'DOCUMENTOS_FISICOS_RECIBIDOS', 'APROBADA', 'APROBADA_PARCIAL', 'RECHAZADA', 'PAGADA') NOT NULL DEFAULT 'ENVIADA',
...
-- 12. Bolsa y Detalle de Documentos de Rendicion
