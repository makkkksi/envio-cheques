...
class RendicionesService
{
    ...
    private const TRANSICIONES = [
        ...
        'EN_REVISION_TESORERIA' => ['PENDIENTE_APROBACION_RESPONSABLE', 'DOCUMENTOS_FISICOS_RECIBIDOS', 'APROBADA', 'APROBADA_PARCIAL', 'RECHAZADA'],
        'PENDIENTE_APROBACION_RESPONSABLE' => ['APROBADA', 'RECHAZADA', 'EN_REVISION_TESORERIA'],
        'DOCUMENTOS_FISICOS_RECIBIDOS' => ['PENDIENTE_APROBACION_RESPONSABLE', 'APROBADA', 'APROBADA_PARCIAL', 'RECHAZADA'],
        'APROBADA' => ['PAGADA'],
