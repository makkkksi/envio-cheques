...
try {
    ...
    if ($documentId > 0) {
        ...
        $stmt->execute([
            ...
            ':razon_social_proveedor' => $isToll ? null : mb_substr($document['razon_social_proveedor'], 0, 150),
            ...
            ':descripcion' => $document['descripcion'] !== '' ? mb_substr($document['descripcion'], 0, 500) : null,
        ...
        $stmt->execute([
            ':empresa_id' => $seller['empresa_id'],
            ':vendedor_id' => $seller['vendedor_id'],
            ':vendedor_nombre' => mb_substr($seller['nombre'], 0, 150),
            ':vendedor_email' => mb_substr($seller['email'], 0, 150),
            ':tipo_documento' => $document['tipo_documento'],
            ':categoria_gasto' => $document['categoria_gasto'],
            ':rut_proveedor' => $isToll ? null : RendicionesService::normalizeRut($document['rut_proveedor']),
            ':razon_social_proveedor' => $isToll ? null : mb_substr($document['razon_social_proveedor'], 0, 150),
